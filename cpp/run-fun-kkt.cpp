...
#include "streaming/contraction/KKTContraction.h"
...
int main(int argc, char *argv[]) {
	...
	// TODO: actually used it in these
	...
	em_mapping cc_map; // to hold result
	{
		...
		FunctionalSubproblemManager<EdgeStream, KKTContraction> funman(p, input_stream, sizeof(node_t) * semiexternal_size, num_nodes, policy, seed);
